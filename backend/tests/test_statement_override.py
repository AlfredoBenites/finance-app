"""Tests for the manual statement-balance override on a credit card."""
...
def test_override_sets_the_statement_due(api):
    ...
    # The dashboard's statement for this card now equals the override.
...
def test_clearing_override_reverts_to_inferred(api):
    ...
    # With no charges and no override, the inferred statement is 0.
    dash = api.client.get("/api/dashboard").json()

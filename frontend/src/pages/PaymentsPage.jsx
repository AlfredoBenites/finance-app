      ...
      <div className="flex items-center gap-2 mb-3 flex-wrap">
        ...
        <div className="flex-1 flex justify-center">
          <button
            ...
            className="grid place-items-center h-9 w-9 rounded-md border border-transparent text-muted transition-colors hover:border-accent hover:bg-accent hover:text-accent-ink active:brightness-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent"
          >
            <RotateCcw size={16} />
          </button>
        </div>
